def main():
    ...
    #  for tracking count over each word of list
    for word in words:
    ...
    #  for printing histogram from Dictionary 
...
def print_histogram_bar(word, count):
    ...
    Uses formatted strings to do so. 
    The {word : <8} adds white space after a string to make
    the string take up 8 total characters of space.
    This makes all of our words on the left of the 
    histogram line up nicely. 
    
    On the other end, {'x' * count}
